...
class PiCamera:
    ...
    def __init__(self):
        ...
        # repeat=True 在每帧内(I 帧)重复流的序列头，即使流被中途接收，也能有效解析帧头
        ...
        self.output = FfmpegOutput("-tune zerolatency -f mpegts udp://{0}:{1}".format(Config.camera_client_addr[0],
...
# 增加0延迟参数 -tune zerolatency
# preset ultrafast（转码速度最快，视频往往也最模糊）-preset ultrafast
# # output1 = FfmpegOutput("-f mpegts udp://192.168.137.1:12345")
